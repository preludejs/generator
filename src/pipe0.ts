...
/**
 * Type definition for pipe0 with various arities
 */
export type Pipe0 = {
  <A>(): (a: A) => A,
  <A,B>(b: Z<A,B>): (a: A) => B,
 ...
 * @returns A function that takes an input and returns the result of applying all transformations
 *
 * @example
 * ```ts
